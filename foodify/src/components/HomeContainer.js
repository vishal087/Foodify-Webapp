...
const HomeContainer = () => {
  return (
    ...
    <p className="text-[2rem] lg:text-[4.5rem] font-bold tracking-wide text-headingColor">The Fastest Delivery in <span className="text-orange-600 text-[3rem] lg:text-[5rem]">Your City</span></p>
    

    <p className="text-base text-textColor text-center md:text-left md:w-[80%]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, itaque iure? Nemo assumenda iusto eius in neque consequatur, totam aut. Possimus porro nihil eius soluta. Commodi voluptatum doloremque velit modi.</p>
    ...
    <div className="py-2 flex-1 flex items-center relative">
     <img src={Herobg} className=" h-420 w-full lg:h-650 lg:w-auto ml-auto " alt="HeroBg" />
     <div className="w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px-32 py-4 gap-4 flex-wrap ">
        {heroData && heroData.map(n=>(
             ...
             <img src={n.imageSrc} className=" w-20 lg:w-40 -mt-10 lg:-mt-20" alt={n.imageSrc} />
