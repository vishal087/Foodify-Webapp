    ...
    <header className="fixed z-50 w-screen  p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between ">
        ...
        <div className=" flex items-center gap-8">
          <motion.ul initial={{opacity:0,x:200}} animate={{opacity:1,x:0}} exit={{opacity:0,x:200}} className="flex items-center gap-8">
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor duration-100 transition-all ease-in-out" onClick={()=>setIsMenu(false)}>
              Home
            </li>
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor duration-100 transition-all ease-in-out" onClick={()=>setIsMenu(false)}>
              Menu
          ...
          <div className="relative">
            ...
            {isMenu && (
              <motion.div
                ...
                className="w-40 bg-gray-50 drop-shadow-xl rounded-lg flex flex-col absolute  top-12 right-0 "
              >
                {user && user.email === "vishu08072001@gmail.com" && (
                  <Link to={"/createItem"}>
      ...
      <div className="flex items-center justify-between md:hidden w-full h-full">
        ...
        <div className="relative">
            ...
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor duration-100 transition-all ease-in-out hover:bg-slate-100 px-4 py-2" onClick={()=>setIsMenu(false)}>
              Home
            </li>
            <li className="text-base text-textColor cursor-pointer hover:text-headingColor duration-100 transition-all ease-in-out hover:bg-slate-100 px-4 py-2" onClick={()=>setIsMenu(false)}>
              Menu
